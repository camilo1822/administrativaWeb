...
public class ControlListValidationServiceBean implements
        ControlListValidationServiceBeanLocal {
     ...
     */
    private ResponseHeaderOutMessageType validateCustomer(
            CustomerType customer, String region) {
        ...
        validateCustomerListsServiceBrokerRequestType
                .setValidateCustomerListsBrokerRQ(validateCustomerListsBrokerRQType);
    ...
    private ResponseHeaderOutMessageType createBrokerRequest(
        ...
        try {
            ...
            responseHeaderOutMessageType = RestClientImpl.getInstance(
                    resourcesPojo)
