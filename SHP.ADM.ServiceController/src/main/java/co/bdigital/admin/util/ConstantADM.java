...
public class ConstantADM {
    ...
    public static final String ERROR_INVALID_LONGITUD = "Error en la lectura del archivo. La longitud debe ser un número negativo y siempre debe contener un punto. Mirar CODIGO INTERNO {0}";
    public static final String ERROR_INVALID_LATITUD = "Error en la lectura del archivo. La latitud debe ser un número positivo y siempre debe contener un punto. Mirar CODIGO INTERNO {0}";
    public static final String ERROR_INVALID_ACTION = "Error en la lectura del archivo. La acción debe ser una de las letras C-R-U-D. Mirar CODIGO INTERNO {0}";
    public static final String ERROR_INVALID_COUNTRY = "Error en la lectura del archivo. La región debe ser {0}. Mirar CODIGO INTERNO {1}";
    ...
    public static final String RESET_WITHOUT_OTP_SUCCESS = "Se realizó correctamente el reseteo de biometría sin OTP";
    ...
    public static final int AW_USER_NAMES_MAX_LENGTH = 60;
    public static final int AW_USER_LAST_NAMES_MAX_LENGTH = 60;
    public static final int AW_USER_MAIL_MAX_LENGTH = 60;
    ...
    public static final String ERROR_GET_PROMOTION_DESC = "Error al traer las relgas de la promocion";
    ...
    public static final String ORIGINAL = "áéíóúñÁÉÍÓÚÑ";
    public static final String TO_REPLACE = "aeiounAEIOUN";
    ...
    public static final int COMMON_INT_TWELVE = 12;
    ...
    public static final String REGULAR_EXPRESION_ACTION = "^[C|R|U|D|]$";
