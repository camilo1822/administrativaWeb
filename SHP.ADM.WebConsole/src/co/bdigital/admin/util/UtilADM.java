...
public class UtilADM {
    ...
    public static String getUrlContextPath() {
        ...
        String urlContext = url.substring(0, url.length()
    ...
    public static RequestMessageObjectType getRequestObject(String serviceName,
            String serviceOperacion, String serviceRegion, String serviceVersion) {
     ...
     * @return
     */
    public static String createMessageAudit(StatusResponse status, String data) {
    ...
    public static RequestBodyType getRequestBodyIntegratioGetFile(
        ...
        getFileRequestType.setBucket(getKeyAndBucketImg
                .get(ConstantADM.MAP_BUCKET_URL_S3));
        getFileRequestType.setFileKey(getKeyAndBucketImg
                .get(ConstantADM.MAP_KEY_URL_S3));
        ...
        message = new FacesMessage(
                ...
                ConstantADM.WORD_ERROR
                        + (null == status || null == status.getStatusCode()
                                || status.getStatusCode().isEmpty() ? ConstantADM.STATUS_CODE_DEFAULT_ERROR
                                : status.getStatusCode()),
                null == status || null == status.getStatusDesc()
                        || status.getStatusDesc().isEmpty() ? defaultErrorMessage
     ...
     * @return URL para consumir los servicios de middleware.
     */
    public static String getUrlRestServicesEndPoint(WsProvider mdwServicesInfo) {
